          ...
          <div className="container">
            ...
            <Switch>
              ...
              <PrivateDoctorRoute
                ...
                component={Dashboard}
              />
              <PrivateDoctorRoute exact path="/meeting" component={Meeting} />
              <PrivateDoctorRoute
                exact
                path="/add-education"
              ...
              />
              <PrivateUserRoute exact path="/payment" component={Payment} />
              <PrivateUserRoute exact path="/form" component={Form} />
              <PrivateUserRoute exact path="/result" component={Result} />
              <PrivateUserRoute
                exact
                path="/appointment/:id"
