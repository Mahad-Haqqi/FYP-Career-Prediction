export const personality = {
  ...
  ISTP: [
    ...
    "This individual prefers to take on roles in which they master the tools of their trade. Those with the ISTP personality type tend to prefer taking action, and good career paths for them are pilot, emergency room physician, data communications analyst, or civil ",
  ],
  ISFP: [
    "The Composer",
